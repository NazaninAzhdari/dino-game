...
architecture RTL of draw_bat is
    ...
    begin
        ...
        o_draw_bat_buttom <= r_bat2_buttom when r_wing2_DV= '1' else r_bat1_buttom;
        o_draw_bat_middle <= r_bat2_middle when r_wing2_DV= '1' else r_bat1_middle;
        o_draw_bat_top <= r_bat2_top when r_wing2_DV= '1' else r_bat1_top;
